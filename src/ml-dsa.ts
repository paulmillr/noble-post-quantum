...
function getDilithium(opts_: TArg<DilithiumOpts>): TRet<DSA> {
  ...
  const internal: TRet<DSAInternal> = Object.freeze({
    ...
    sign: (
      ...
      // Validate/prepare signing entropy before any secret material is expanded, so malformed
      // extraEntropy throws without leaving decoded s1/s2/t0 copies behind.
